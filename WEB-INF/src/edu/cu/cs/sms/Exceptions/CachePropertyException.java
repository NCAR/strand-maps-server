...
public class CachePropertyException extends IOException {

    private static final long serialVersionUID = 3761688978973603382L;

    public CachePropertyException(String msg) {
        super(msg);
    }
