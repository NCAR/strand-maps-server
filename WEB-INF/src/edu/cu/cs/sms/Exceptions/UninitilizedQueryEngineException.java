...
public class UninitilizedQueryEngineException extends Exception {

    private static final long serialVersionUID = 4048795645668241718L;

    public UninitilizedQueryEngineException(String msg) {
        super(msg);
    }
}
