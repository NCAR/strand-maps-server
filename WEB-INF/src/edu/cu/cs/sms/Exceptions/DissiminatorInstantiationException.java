...
public class DissiminatorInstantiationException extends InstantiationException {
    private static final long serialVersionUID = 3257008752316986417L;

    public DissiminatorInstantiationException(String msg) {
        super(msg);
    }
