...
public class DissiminatorClassNotFoundException extends ClassNotFoundException {

    private static final long serialVersionUID = 3257283634552844853L;

    public DissiminatorClassNotFoundException(String msg) {
        super(msg);
    }
}
