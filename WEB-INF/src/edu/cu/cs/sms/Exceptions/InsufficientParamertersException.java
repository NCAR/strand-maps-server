...
public class InsufficientParamertersException extends Exception {
    ...
    private static final long serialVersionUID = 3257285842249594673L;

    public InsufficientParamertersException() {
        super();
    }

    public InsufficientParamertersException(String arg0) {
        super(arg0);
    }

    public InsufficientParamertersException(Throwable arg0) {
        super(arg0);
    }

    public InsufficientParamertersException(String arg0, Throwable arg1) {
        super(arg0, arg1);
    }
}
