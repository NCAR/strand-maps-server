...
package edu.cu.cs.sms.Exceptions;

public class IllegalServiceRequestCombinaition extends Exception {

    private static final long serialVersionUID = 3257569511954788407L;

    public IllegalServiceRequestCombinaition() {
        super();
    }

    public IllegalServiceRequestCombinaition(String arg0) {
        super(arg0);
    }

    public IllegalServiceRequestCombinaition(Throwable arg0) {
        super(arg0);
    }

    public IllegalServiceRequestCombinaition(String arg0, Throwable arg1) {
        super(arg0, arg1);
    }
}
