...
public class ResourceBundleLoadException extends IOException {

    private static final long serialVersionUID = 3905800881365660466L;

    public ResourceBundleLoadException(String msg) {
        super(msg);
    }
}
