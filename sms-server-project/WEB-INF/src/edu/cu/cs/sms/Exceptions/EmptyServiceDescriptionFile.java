...
public class EmptyServiceDescriptionFile extends Exception {
    private static final long serialVersionUID = 3977859592095282740L;

    Throwable ex = null;

    public EmptyServiceDescriptionFile(Throwable e) {
        ex = e;
    }
