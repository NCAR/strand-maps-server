...
public class DatabaseClassNotFoundException extends ClassNotFoundException {

    private static final long serialVersionUID = 4049633512233579575L;

    public DatabaseClassNotFoundException(String msg) {
        super(msg);
    }
}
