...
public class DatabaseInstantiationException extends InstantiationException {

    private static final long serialVersionUID = 3979274642102170419L;

    public DatabaseInstantiationException(String msg) {
        super(msg);
    }
}
