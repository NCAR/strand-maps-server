...
{
	public abstract boolean mergeSkeletonInfo(HashMap in);
	public abstract void add(SMSResult rs) throws SQLException,CorruptDataException;
	public abstract boolean checkID(SMSData in);
	public abstract SMSData getObject(int index);
