...
public class DissiminatorFactory extends BaseKeyedPoolableObjectFactory {

    public Object makeObject(Object key) throws Exception {
        String[] supportedFormats = (String[]) ExtendedActionServlet.cxt
                .getAttribute("supportedFormats");

        for (int counter = 0; counter < supportedFormats.length; counter++) {
            Class temp = (Class) ExtendedActionServlet.cxt
